...
1. [Google AI Studio](https://aistudio.google.com/apikey) にアクセス（Google アカウントでログイン）
2. 「API キーを作成」をクリック
3. 表示されたキーをコピーし、LLMime の設定画面に貼り付け

> 無料枠で十分に利用できます。クレジットカードの登録は不要です。
